...
public class StatisticsLogger {
	...
	public void logStatistics(long maxPeriodInformed, double maxErrorInformed,
			double tardinessSum, long numberOfInformations,
			long numberOfTardinessGreatherThenTriggerPoint,
			long numberOfTardinessGreatherThenTriggerUpperLimit) {
		writeLock.lock();
		try {
			outRegister.println(System.currentTimeMillis()
					...
					+ tardinessSum + "; " + numberOfInformations + "; "
					+ numberOfTardinessGreatherThenTriggerPoint + "; "
					+ numberOfTardinessGreatherThenTriggerUpperLimit);
