...
public abstract class MaspAgent extends Agent {
	...
	public Spatial2Dstate spatial2Dstate = new Spatial2Dstate();
	public VirtualSpaceMirror virtualSpaceMirror = VirtualSpaceMirror
			.getInstance();
	public VirtualSpace virtualSpace = VirtualSpace.getInstance();
	...
	protected void setup() {
		...
		startSimulationTimeTardinessInforming(this);

		loadBehaviours(behaviours);
		setupSimulation();
		// setupSimulationClass();
